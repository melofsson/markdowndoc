...
(function (global, factory) {
  ...
  class BaseComponent extends Config {
    ...
    static eventName(name) {
      return `MarkdownDoc${this.EVENT_KEY}`;
    }
  ...
  const enableDismissTrigger = (component, method = 'hide') => {
    ...
    EventHandler.on(document, clickEvent, `[data-bs-dismiss="MarkdownDoc"]`, function (event) {
      ...
      const target = getElementFromSelector(this) || this.closest(`.MarkdownDoc`);
    ...
    return function createPopper(reference, popper, options) {
      ...
      var instance = {
        ...
        forceUpdate: function forceUpdate() {
          ...
          // To ensure persistent data, use `MarkdownDoc#persistent`
